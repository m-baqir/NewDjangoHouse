...
def TorontoMapApi (request):
    response = requests.get('https://ckan0.cf.opendata.inter.prod-toronto.ca/ne/api/3/action/datastore_search?resource_id=a083c865-6d60-4d1d-b6c6-b0c8a85f9c15').json;
